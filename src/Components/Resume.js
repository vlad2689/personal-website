        ...
        return (
          <div key={education.school}>
            ...
            {Array.isArray(education.description) && (
              <div>
                {education.description.map((descriptionParagraph) => (
      ...
      var skills = this.props.data.skills.map(function (skill) {
        return (
          <div className="columns feature-item">
            <img className="skill" alt={skill.alt} src={skill.imgSrc}></img>
            <h5>{skill.name}</h5>
